...
def main():
    ...
    with col1:
        if st.button('Vai a Enchanted Equities v2', help='Clicca per visitare la versione v2 del sito'):
    ...
    with col2:
        if st.button('Vai a Enchanted Equities Test Analyze Pro', help='Clicca per visitare la versione Test Analyze Pro del sito'):
